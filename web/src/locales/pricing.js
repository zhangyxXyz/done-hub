export const pricingTranslations = {
  zh: {
    ...
    'modelpricePage.cached_write_1h_tokens': '缓存写入令牌(1h)',
    'modelpricePage.cached_read_tokens': '缓存读取令牌',
    'modelpricePage.openai_cache_write_tokens': '缓存写入令牌(openai)',
  ...
  en: {
    ...
    'modelpricePage.openai_cache_write_tokens': 'Cached Write Tokens (OpenAI)',
