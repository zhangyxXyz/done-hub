  ...
  const submitNotice = async () => {
    ...
    try {
      const updates = [
        ...
        ['NoticeAutoPopup', inputs.NoticeAutoPopup]
      ];
      ...
      <Stack spacing={2}>
        <SubCard title={t('setting_index.otherSettings.generalSettings.title')}>
          <Grid container spacing={{ xs: 3, sm: 2, md: 4 }}>
            ...
            <Grid xs={12}>
              <FormControlLabel
                label={t('setting_index.otherSettings.generalSettings.noticeAutoPopupLabel')}
                control={
                  <Checkbox
                    checked={inputs.NoticeAutoPopup !== 'false'}
                    onChange={handleInputChange}
                    name="NoticeAutoPopup"
                    disabled={loading}
                  />
                }
              />
              <Typography variant="body2" color="textSecondary">
                {t('setting_index.otherSettings.generalSettings.noticeAutoPopupHelper')}
              </Typography>
            </Grid>
            <Grid xs={12}>
