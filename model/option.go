...
func InitOptionMap() {
	...
	config.GlobalOption.RegisterBool("NoticeAutoPopup", &config.NoticeAutoPopup)
	...
	config.GlobalOption.RegisterBool("AutoModelInfoUpdates", &config.AutoModelInfoUpdates)
	config.GlobalOption.RegisterString("AutoModelInfoUpdatesMode", &config.AutoModelInfoUpdatesMode)
	config.GlobalOption.RegisterInt("AutoModelInfoUpdatesInterval", &config.AutoModelInfoUpdatesInterval)
	config.GlobalOption.RegisterString("AutoModelInfoUpdatesCron", &config.AutoModelInfoUpdatesCron)
	config.GlobalOption.RegisterString("UpdateModelInfoService", &config.UpdateModelInfoService)
