...
24. `UPDATE_PRICE_SERVICE` ：设置之后将使用指定的价格服务更新价格。不设置则使用系统默认价格服务`https://raw.githubusercontent.com/zhangyxXyz/done-hub/refs/heads/llm-model-info/prices/prices.json`
